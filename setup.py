...
#
setup_keywords['name'] = 'unetabs'
setup_keywords['description'] = 'U-Net for Absorption Lines'
setup_keywords['author'] = 'Cai and Associates'
setup_keywords['author_email'] = 'zcai@ucolick.org'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/caiz12/Unet-abs'
#
